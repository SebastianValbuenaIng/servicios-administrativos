...
public class VcdProfService implements IVcdProfService {
    ...
    public VcdProfService(CandidatosRepository candidatosRepository,
    ...
    public Map<String, String> verificarEstadoVoto(String email) {
        ...
        estado.put("estado", votanteFind.getVcd_prof().toString());
        return estado;
    }

    @Override
    public List<CandidatosEntity> buscarCandidatos() {
        List<CandidatosEntity> buscarCandidatos = candidatosRepository.findAllByIdcrp(119);
